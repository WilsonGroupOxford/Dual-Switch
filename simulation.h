...
private:
    ...
    //Analysis
    bool convertDual, periodicVis, spatialRdf, topoRdf, assortative, ringAreas; //convert to atomic network, periodic visualisation, spatial partial rdfs, topological rdfs, ring areas
